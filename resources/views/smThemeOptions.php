...
//                    "max" => "120"
//                ],
                "project_top_section_title" => [
                    "label" => "Project top section title ",
                    "default" => "BUILD YOUR DREAM HOME",
                    "type" => "text"
                ],
                "project_top_section_caption" => [
                    "label" => "Project top section caption ",
                    "default" => "COME TO THE WORLD SINCE 1809",
                    "type" => "text"
                ],
                "project_top_section_link" => [
                    "label" => "Project top section link ",
                    "default" => "#",
                    "type" => "text"
                ],
                "project_top_section_image" => [
                    "type" => "upload",
                    "label" => "Project Top Section Image",
                    "desc" => "Select or upload Project top image from here.(270,450)",
                    "default" => "",
                ],
                ...
                "extra_facilities" => [
                    ...
                    "single_title" => "facelities_title",
                    "add_more_title" => "Add more Facilities",
                    "template" => "facilities_title",
                    "fields" => [
                        "facilities_title" => [
                            "label" => "Facilities Title",
                            "default" => "Facilities Title",
                            "type" => "text",
                            "extra" => [
                                "required" => ""
                            ]
...
//                ],
                ...
                "total_complete_project_icon" => [
                    "type" => "upload",
                    "label" => "Projects Completed Icon",
                    "desc" => "Select or upload Projects Completed icon from here.",
                    "default" => "",
                ],
                ...
                "total_happy_client_icon" => [
                    "type" => "upload",
                    "label" => "Happy Client Icon",
                    "desc" => "Select or upload happy client icon from here.",
                    "default" => "",
                ],
                "qualified_staff" => [
                    "type" => "number",
                ...
                "qualified_staff_icon" => [
                    "type" => "upload",
                    "label" => "Qualified Staff Icon",
                    "desc" => "Select or upload your Staff Icon  from here.",
                    "default" => "",
                ],
//                "total_commitment" => [
//                    "type" => "number",
...
//                        ]
        ...
        "our_client" => [
            ...
            "fields" => [
                "client_banner_title" => [
                    "type" => "text",
                    "label" => "Client Banner Title",
                    "default" => "JOIN OUR CLIENT"
                ],
                "client_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Client Banner Subtitle",
                    "default" => "A World of Opportunities"
                ],
                "client_banner_image" => [
                    "type" => "upload",
                    "label" => "Client Banner Image",
                    "desc" => "Select or upload your link generate image from here.",
                    "default" => ""
                ],
                "client_title" => [
                    "type" => "text",
                    "label" => "Client Title",
                    "default" => "Expert Client"
                ],
                "client_subtitle" => [
                    "type" => "text",
                    "label" => "Client Subitle",
                    "default" => "Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium."
                ],
                "clients" => [
                    "type" => "addable-popup",
                    "label" => "Client",
                    "desc" => "Add Client by clicking here",
                    "single_title" => "Our Client Info",
                    "add_more_title" => "Add more team",
                    "template" => "title",
                    "fields" => [
                        "client_image" => [
                            "type" => "upload",
                            "label" => "Photo",
                            "desc" => "Select or upload your Client member photo from here.",
                            "default" => "",
                            "extra" => [
                                "required" => "",
                            ]
                        ...
                        "title" => [
                            "label" => "Name",
                            "type" => "text",
                            "desc" => "Write your Client member name here.",
                            "extra" => [
                                "required" => ""
                            ]
                        ],
                        "mobile" => [
                            "label" => "Mobile",
                            "type" => "text",
                            "desc" => "Write your Client member mobile here."
                        ],
                        "email" => [
                            "label" => "Email",
                            "type" => "email",
                            "desc" => "Write your Client member email here."
                        ],
                        "address" => [
                            "label" => "Address",
                            "type" => "textarea",
                ...
                "client_seo_title" => [
                    "type" => "text",
                    "label" => "Client SEO Title",
                ],
                "client_meta_keywords" => [
                    "type" => "text",
                    "label" => "Client Meta Keywords",
                ],
                "client_meta_description" => [
                    "type" => "textarea",
                    "label" => "Client Meta Description",
                ]
            ]
        ],
        ...
        "concern" => [
            ...
            "type" => "fields",
            "fields" => [
                "concern_banner_title" => [
                    "type" => "text",
                    "label" => "Concern Banner Title",
                    "default" => "JOIN OUR Concern"
                ],
                "concern_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Concern Banner Subtitle",
                    "default" => "A World of Opportunities"
                ],
                "concern_banner_image" => [
                    "type" => "upload",
                    "label" => "Concern Banner Image",
                    "desc" => "Select or upload your link generate image from here.",
                    "default" => ""
                ],
                "concern_section" => [
                    "type" => "addable-popup",
                    "label" => "Concern",
                    "desc" => "Add Concern List by clicking here",
                    "single_title" => "Our Concern Info",
                    "add_more_title" => "Add more Concern",
                    "template" => "title",
                    "fields" => [
                        "concern_image" => [
                            "type" => "upload",
                            "label" => "Photo",
                            "desc" => "Select or upload your Concern  photo from here.",
                            "default" => "",
                            "extra" => [
                                "required" => "",
                            ]
                        ...
                        "title" => [
                            "label" => "Name",
                            "type" => "text",
                            "desc" => "Write your Concern member name here.",
                            "extra" => [
                                "required" => ""
                            ]
                        ],
                        "short_description" => [
                            ...
                            "type" => "textarea",
                            "desc" => "Write your Concern member mobile here.",
                            "extra" => [
                                "row" => "4",
                            ]
                        ],
                        ...
                        "concern_is_enable" => [
                            "type" => "select",
                            "label" => "Is concern popular posts enable?",
                            "desc" => "Do you want to enable concern?",
                            "fields" => [
                                 "" => "Select Status",
                            "1" => "Yes",
                            "0" => "No",
                ...
                "concern_seo_title" => [
                    "type" => "text",
                    "label" => "Concern SEO Title",
                ],
                "concern_meta_keywords" => [
                    "type" => "text",
                    "label" => "Concern Meta Keywords",
                ],
                "concern_meta_description" => [
                    "type" => "textarea",
                    "label" => "Concern Meta Description",
                ]
            ]
        ],
        "our_service" => [
            ...
            "fields" => [
                "service_banner_title" => [
                    ...
                    "default" => "See our service"
                ],
                "service_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Service Banner Subtitle",
                    "default" => "A World of Opportunities service"
                ],
        ...
        "our_project" => [
            ...
            "fields" => [
                "project_banner_title" => [
                    "type" => "text",
                    "label" => "Project Banner Title",
                    "default" => "See our service"
                ],
                "project_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Project Banner Subtitle",
                    "default" => "A World of Opportunities service"
                ],
                ...
                "project_related_posts_per_page" => [
                    "type" => "slider",
                    "label" => "Project per page",
                    "desc" => "Select Project per page that you need",
                    "default" => 12
                ],
            ]
        ],
        "our_construction" => [
            ...
            "type" => "fields",
            "fields" => [
                "construction_banner_title" => [
                    "type" => "text",
                    "label" => "Construction Banner Title",
                    "default" => "See our service"
                ],
                "construction_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Construction Banner Subtitle",
                    "default" => "A World of Opportunities service"
                ],
                "construction_banner_image" => [
                    "type" => "upload",
                    "label" => "Construction Banner Image",
                    "desc" => "Select or upload your link generate image from here.",
                    "default" => ""
                ],
                "construction_related_posts_per_page" => [
                    "type" => "slider",
                    "label" => "Construction per page",
                    "desc" => "Select Construction per page that you need",
                    "default" => 12
                ],
            ]
        ],
        "flat_for_sale" => [
            ...
            "type" => "fields",
            "fields" => [
                "flat_for_sale_banner_title" => [
                    "type" => "text",
                    "label" => "Flat For Sale Banner Title",
                    "default" => "Flat For Sale"
                ],
                "flat_for_sale_banner_subtitle" => [
                    "type" => "text",
                    "label" => "Flat For Sale Banner Subtitle",
                    "default" => "A World of Opportunities service"
                ],
                "flat_for_sale_banner_image" => [
                    "type" => "upload",
                    "label" => "Flat For Sale Banner Image",
                    "desc" => "Select or upload your link generate image from here.",
                    "default" => ""
                ],
                "flat_for_sale_related_posts_per_page" => [
                    "type" => "slider",
                    "label" => "Flat For Sale per page",
                    "desc" => "Select Flat For Sale per page that you need",
                    "default" => 12
                ],
            ]
        ],
...
//                ],
                ...
                "copyrightlink" => [
                    ...
                    "extra" => [
                        "required" => "",
                        "placeholder" => "Add your copyright link here.",
                        "id" => "",
                        "class" => ""
                    ]
                ],
