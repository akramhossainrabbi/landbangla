...
<footer class="bg_black">
                ...
                <div class="col-3 item">
                    <div class="single-footer">
                        ...
                        <button type="submit" value="Subscribe" id="newsletterFormSubmit"
                                class="btn btn-success form-control">Submit</i>
                        </button>
                        {!! Form::close() !!}
    ...
    <div class="footer_last bg_gray_dark pt-3 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-6 item text-right color_white">
                    &copy; Business Consultant on Demand
                </div>
                <div class="col-12 col-sm-6 item color_white">
                    {{ SM::smGetThemeOption("copyright") }} : <a style="color: #5cad5c;" target="_blank" href="http://nextpagetl.com/">Next Page Technology
                        Ltd.</a>
                </div>
            </div>
        </div>
