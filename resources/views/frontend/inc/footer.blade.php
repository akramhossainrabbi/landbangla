...
<!--                            <div class="con_text">-->
<!--                                <h4>Newsletter</h4>-->
<!--                                <h6>{{$newsletter_success_title}}</h6>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_first">
                        <div class="footer-contant">
                            <img src="{{ SM::sm_get_the_src(SM::smGetThemeOption("footer_logo"), 120, 237) }}" class="foot_logo" alt="">
                            <div class="footer-title" >
                            	 <ul style="color: #fff;margin-bottom: 10px">
	                                 <li style="color: #fff;margin-bottom: 10px"><i class="fa fa-map-marker" aria-hidden="true"> </i> {{$address}}</li>
	                                <li style="color: #fff;margin-bottom: 10px"><i class="fa fa-phone" aria-hidden="true"> </i> Call Us: {{$mobile}}</li>
	                                <li style="color: #fff;margin-bottom: 10px"><i class="fa fa-envelope-o" aria-hidden="true"> </i> Email Us:{{$email}}</li>
                               </ul>
                            </div>
                            <div class="footer_social">
                                <div>
                                    <ul>
                                        ...
                                        <li><a href="{{SM::smGetThemeOption("social_facebook")}}"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        @endif
                                        @empty(!SM::smGetThemeOption("social_twitter"))
                                        <li><a href="{{SM::smGetThemeOption("social_twitter")}}"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                        @endif
                                        @empty(!SM::smGetThemeOption("social_linkedin"))
                                            <li><a href="{{SM::smGetThemeOption("social_linkedin")}}"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                        @endif
                                        @empty(!SM::smGetThemeOption("social_google_plus"))
                                        <li><a href="{{SM::smGetThemeOption("social_google_plus")}}"><i class="fa fa-google" aria-hidden="true"></i></a></li>
                                        @endif
                                        @empty(!SM::smGetThemeOption("social_github"))
                                        <li><a href="{{SM::smGetThemeOption("social_github")}}"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                        @endif
                                        @empty(!SM::smGetThemeOption("social_youtube"))
                                        <li><a href="{{SM::smGetThemeOption("social_youtube")}}"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="footer_second">
                        <div>
                            <div class="footer-title">
                                <h3>{{SM::smGetThemeOption("footer_widget2_title")}}</h3>
                            </div>
                            <div class="footer-contant">
                                {!! SM::smGetThemeOption("footer_widget2_description") !!}
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ul>
                                    ...
                                    @foreach($gallery as $gallerys)
                                        <?php $galleryssss=explode(',',$gallerys->image_gallery);?>
                                          <li><a href="{{url('gallery/'.$gallerys->slug)}}"><img src="{!! SM::sm_get_the_src($galleryssss[0], 80, 80) !!}" alt="" style="height: 50px;width: 50px"></a></li>
                                    @endforeach
                                    @endif
                                </ul>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="cop_p">
                        ...
                        <p>{!! SM::smGetThemeOption("copyright") !!} NextPage Technology Ltd. All rights reserved</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="copy_link">
                        <ul>
                            {!! SM::smGetThemeOption("copyrightlink") !!}
                        </ul>
                    </div>
                </div>
            </div>
