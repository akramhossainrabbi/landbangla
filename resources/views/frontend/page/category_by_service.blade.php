...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            @foreach($services as $pKey=> $service_list)
            <div class="col-md-4">
                <div class="service-content-box wow slideInLeft" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="images-box">
                        <img src="{!! SM::sm_get_the_src($service_list->image, 350, 350) !!}" class="img-responsive"> 
                    </div>
                    <div class="service-box">
                        <h2 class="service-title"><a href="{{url('/service-details/'.$service_list->slug)}}">{{$service_list->title}}</a></h2>
