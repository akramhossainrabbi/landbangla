...
@section('content')
    ...
    $project_banner_title = SM::smGetThemeOption("construction_banner_title");

    $project_banner_subtitle = SM::smGetThemeOption("construction_banner_subtitle");
             ...
             <ul class="nav nav-tabs project-navtabs">
              ...
              <div class="tab-content">
                ...
                <div class="row zoom-gallery">
                    @foreach($project_data as $construction)
                        ...
                        <div class="isotopeSelector col-lg-4 col-sm-6 cate_7">
                            <div class="our-portfolio aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                                <div class="pic">
                                    <img src="{!! SM::sm_get_the_src($construction->image, 350, 350) !!}">
                                    <ul class="social">
                                        <li class="zoom_gallery " href="{!! SM::sm_get_the_src($construction->image, 800, 800) !!}">
                                            <img src="" class="img-fluid blur-up lazyloaded" alt="">
                                            <a class="fa fa-plus"></a>
                                        </li>
                                        <li><a href="{{url('constructions/'.$construction->slug)}}" class="fa fa-link"></a></li>
                                    </ul>
                                </div>
                                <div class="team-content">
                                    <span class="post"><a href="{{url('constructions/'.$construction->slug)}}">{{$construction->title}}</a></span>
                                </div>
                  ...
                  @foreach($project_cat as $key=>$construction_cat)
                      <?php
                      $cproject_list=$construction_cat->constructions;
                      ?>
                     <div id="cate_{{$category->id}}" class="tab-pane fade">
                    <div class="row zoom-gallery">
                          @foreach($cproject_list as $project)
                              <div class="isotopeSelector col-lg-4 col-sm-6 cate_7">
                                  <div class="our-portfolio aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
                                      <div class="pic">
                                          ...
                                          <ul class="social">
                                              ...
                                              <li><a href="{{url('constructions/'.$project->slug)}}" class="fa fa-link"></a></li>
                                          </ul>
                                      </div>
                                      <div class="team-content">
                                          <span class="post"><a href="{{url('constructions/'.$project->slug)}}">{{$project->title}}</a></span>
                                      </div>
