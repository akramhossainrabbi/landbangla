...
<section class="about_page_img">
    <img src="{!! SM::sm_get_the_src( $bannerImage) !!}">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="who-we-are-content">
                    <h3>{!! SM::smGetThemeOption("wwr_subtitle", "") !!}</h3>
                    <p>{!!  SM::smGetThemeOption("wwr_description", "") !!}</p>
                </div>
            </div>
        </div>
    </div>   
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="section-img">
                                    <img src="{!! SM::sm_get_the_src( $ourMissionbannerImage, 500,250 ) !!}" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="section-contant">
                                    <div class="media-body">
                                        <p>{!!  SM::smGetThemeOption("our_mission", "") !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="our-satisfife-box">
                    ...
                    <div class="mission-vission">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="section-contant">
                                    <p>{!!  SM::smGetThemeOption("our_vision", "") !!}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="section-img">
                                    <img src="{!! SM::sm_get_the_src( $vissionbannerImage, 500,250 ) !!}" class="img-fluid">
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <div class="services-section-title text-center">
                    <h3 class="text-mute">{{$teamTitle}}</h3>
                    <!--<p class="text-mute">{{$teamSubtitle}}</p>-->
                </div> 
            </div>
        </div>
                                ...
                                <div class="item">
                                    <div class="card">
                                        <div class="user-profile-box">
                                          <img src="{!! SM::sm_get_the_src($team["team_image"], 326,381) !!}" class="img-fluid blur-up lazyload "
                                                                 alt="{{ $team["title"] }}">
                                        </div>
                                        <div class="card-body">
                                            <div class="user-profile-content-box">
                                              ...
                                              @if(isset($team["description"]))
                                                <p class="pragraph-text">{{ $team["description"] }}</p>
                                              @endif  
                                              <ul class="social-icons-ql pull-left">
                                                  @if(!empty($team["facebook"]))
                                                    <li><a href="{{$team["facebook"]}}" data-toggle="tooltip" data-placement="top" title="Facebook"><i
                                                                    class="fa fa-facebook"></i></a></li>
                                                    @endif
                                                    @if(!empty($team["twitter"]))
                                                    <li><a href="{{$team["twitter"]}}" data-toggle="tooltip" data-placement="top"
                                                           title="Google-plus"><i class="fa fa-google-plus"></i></a></li>
                                                    @endif
                                                    @if(!empty($team["google_plus"]))
                                                    <li><a href="{{$team["google_plus"]}}" data-toggle="tooltip" data-placement="top"
                                                           title="Twitter"><i class="fa fa-twitter"></i></a></li>
                                                    @endif
                                                    @if(!empty($team["linkedin"]))
                                                    <li><a href="{{$team["linkedin"]}}" data-toggle="tooltip" data-placement="top"
            ...
            <div class="col-md-6">
                   <div class="brand_slide owl-carousel owl-theme">
                        ...
                        <div class="clients-logo-bos">
                            <img src="{!! SM::sm_get_the_src($clients["client_image"], 80, 80) !!}" alt="{{$clients['title']  }}">
                        </div>
                        @endforeach
                    </div> 
            </div>
