                    ...
                    <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <select  class="form-control " name="location" id="location">
                                    ...
                                    <option value="{{$districts->id}}" {{ ( $districts->id == $edit->location) ? 'selected' : '' }}>{{$districts->name}}</option>
                                    @endforeach
                        ...
                        <div class="form-group{{ $errors->has('location_1') ? ' has-error' : '' }}">
                            ...
                            <select  class="form-control " name="location_1" id="location_1">
                                @if(!empty($all_upazilas))
                                    ...
                                    <option value="{{$upazilas->id}}" {{ ( $upazilas->id == $edit->location_1) ? 'selected' : '' }}>{{$upazilas->name}}</option>
                                    @endforeach
                                    @endif
                                <option value="">Please Select</option>
                            </select>
                        ...
                        <div class="form-group{{ $errors->has('project_type') ? ' has-error' : '' }}">
                            ...
                            <select  class="form-control " name="project_type" id="project_type">
                                ...
                                @foreach($all_project as  $project)
                                    ...
                                    <option value="{{$project->slug}}" {{ ( $project->slug == $edit->project_type) ? 'selected' : '' }}>{{$project->title}}</option>
                                @endforeach
