    ...
    <div class="jarviswidget" id="wid-add-category-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        @include("nptl-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'careers', 'name'=>'title'])
                    </div>
                    <div class="col-sm-6">
...
?>
@include('nptl-admin/common/common/image_form',['header_name'=>'Career Banner',
'image'=>$image])
@include('nptl-admin/common/common/meta_info',['header_name'=>'Career',
'width'=>'col-lg-12'])