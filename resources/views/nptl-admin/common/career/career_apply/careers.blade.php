...
<!--    <td>-->
<!--        <a target="_blank" href="{{Storage::disk()->url('career/'.$page->image)}}"><strong>File</strong></a>-->
<!--        <a target="_blank" href="{{ env('APP_URL') }}public/career/{{$page->image}}"><strong>File</strong></a>-->
<!--        <a target="_blank" href="{{ $page->image }}"><strong>File</strong></a>-->
<!--    </td>-->
<!--    <td>-->
...
<tr id="tr_{{$page->id}}">
    ...
    <td><strong><a href="#">{{ $page->career->title }}</a></strong></td>
    <td>
        @if($page->image!= '')
        <a target="_blank" href="{{ env('APP_URL') }}public/career/{{$page->image}}"><strong>Image</strong></a>
        @else
    ...
    <td>
        @if($page->image!= '')
        <a target="_blank" href="{{ env('APP_URL') }}public/career/{{$page->cv}}"><strong>File</strong></a>
        @else
