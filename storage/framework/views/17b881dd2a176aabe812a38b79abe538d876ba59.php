        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="contant-info">
                    <ul>
                        <li><a href="tel:<?php echo e(SM::get_setting_value('mobile')); ?>"><img src="https://glgassets.com/wp-content/themes/glg/assets/images/callNow.png">  <?php echo e(SM::get_setting_value('mobile')); ?>.</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
