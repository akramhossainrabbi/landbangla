    ...
    <div class="jarviswidget" id="wid-add-slider-main" data-widget-editbutton="false" data-widget-deletebutton="false">
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <?php echo $__env->make("nptl-admin.common.common.title_n_slug", ['isEnabledSlug'=>false, "table"=>"sliders"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                    <div class="sm-form<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                        <?php echo Form::label('style', 'Slider Style'); ?>

                        <?php echo Form::select('style',[
...
?>
<?php echo $__env->make('nptl-admin/common/common/image_form',['header_name'=>'Slider', 'image'=>$image], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('nptl-admin/common/common/image_form',['header_name'=>'Slider background', 'image'=>$background_image, 'input_holder'=>'fav_icon', 'img_holder'=>'second_ph'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
