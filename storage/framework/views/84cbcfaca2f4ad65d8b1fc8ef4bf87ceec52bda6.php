...
<?php echo Html::script('frontend/assets/particles/particles.js'); ?>

<?php echo Html::script('frontend/assets/particles/js/app.js'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on('click', '#btn_career_apply', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('get_career_apply')); ?>',
                method: 'GET',
...
<!-- zoom js file -->
<?php echo Html::script('frontend/assets/js/jquery.magnific-popup.js'); ?>


<!-- popper js file -->
<?php echo Html::script('frontend/assets/js/popper.min.js'); ?>
...
<!-- Scroll js file-->
<?php echo Html::script('frontend/assets/js/footer-reveal.min.js'); ?>
...
<!-- Lazy Loader js file-->
<?php echo Html::script('frontend/assets/js/lazysizes.min.js'); ?>


<!-- Counter Js File -->
<?php echo Html::script('frontend/assets/js/jquery.counterup.min.js'); ?>

<?php echo Html::script('frontend/assets/js/jquery.waypoints.min.js'); ?>


<!-- AOS js file-->
<?php echo Html::script('frontend/assets/js/aos.js'); ?>


<!-- script js file -->
<?php echo Html::script('frontend/assets/js/script.js'); ?>


<!-- footer js file -->
<?php echo Html::script('frontend/assets/js/footer.js'); ?>
