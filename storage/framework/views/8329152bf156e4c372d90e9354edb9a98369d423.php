        ...
        <?php endif; ?>
         ...
         <li ctrl="projects">
             ...
             <ul>
                 ...
                 <li mtd="create">
                     <a href="<?php echo e(url(SM::smAdminSlug('project/create'))); ?>">Add Design Projects</a>
                 </li>
                 <?php endif; ?>

                 <?php if (SM::check_this_method_access('projects', 'index')): ?>
                 <li mtd="index">
                     <a href="<?php echo e(url(SM::smAdminSlug('project'))); ?>">All Design Projects</a>
                 </li>
                 <?php endif; ?>
             </ul>
         </li>
         ...
         <li ctrl="constructions"">
             ...
             <ul>
                 ...
                 <li mtd="create">
                     <a href="<?php echo e(url(SM::smAdminSlug('constructions/create'))); ?>">Add Construction</a>
                 </li>
                 <?php endif; ?>

                 <?php if (SM::check_this_method_access('constructions', 'index')): ?>
                 <li mtd="index">
                     <a href="<?php echo e(url(SM::smAdminSlug('constructions'))); ?>">All Construction</a>
                 </li>
                 <?php endif; ?>
             </ul>
         </li>
         ...
         <li ctrl="flatforsales">
             ...
             <ul>
                 ...
                 <li mtd="create">
                     <a href="<?php echo e(url(SM::smAdminSlug('flatforsales/create'))); ?>">Add Projects</a>
                 </li>
                 <?php endif; ?>

                 <?php if (SM::check_this_method_access('flatforsales', 'index')): ?>
                 <li mtd="index">
                     <a href="<?php echo e(url(SM::smAdminSlug('flatforsales'))); ?>">All Projects</a>
                 </li>
                 <?php endif; ?>
             </ul>
         ...
         <li ctrl="galleries">
             ...
             <ul>
                 ...
                 <li mtd="create">
                     <a href="<?php echo e(url(SM::smAdminSlug('galleries/create'))); ?>">Add Gallery</a>
                 </li>
                 <?php endif; ?>
                 <?php if (SM::check_this_method_access('galleries', 'index')): ?>
                 <li mtd="index">
                     <a href="<?php echo e(url(SM::smAdminSlug('galleries'))); ?>">All Gallery</a>
                 </li>
                 <?php endif; ?>
             </ul>
         </li>
         ...
         <li ctrl="coupons" >
             ...
             <ul>
                 ...
                 <?php endif; ?>
                     ...
                     <li ctrl="applicent" >
                         <a href="<?php echo e(url(SM::smAdminSlug('careerapplys'))); ?>">
