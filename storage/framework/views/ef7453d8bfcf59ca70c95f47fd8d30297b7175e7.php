...
<?php $__env->startSection('title','Gallery Lists'); ?>
<?php $__env->startSection('content'); ?>
    <section id="widget-grid" class="">
    <?php
    $edit = SM::check_this_method_access('galleries', 'edit') ? 1 : 0;
    $status_update = SM::check_this_method_access('galleries', 'status_update') ? 1 : 0;
    $delete = SM::check_this_method_access('galleries', 'delete') ? 1 : 0;
    $per = $edit + $delete;
    ?>
    <!-- row -->
        <div class="row">
...
<?php $__env->startSection('footer_script'); ?>
    <script type="text/javascript">
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo e(route('dataProcessingGallery')); ?>",
                "dataType": "json",
                "type": "GET",
    ...
    <script type="text/javascript">
        ...
        var fnUpdateCount = function () {
            var generallen = $("#example input[name='multi_select[]']:checked").length;
            if (generallen > 0) {
            ...
            $('.delete_all').on('click', function (e) {
                ...
                if (allVals.length <= 0) {
                    ...
                    if (check == true) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('deleteMultipleGallery')); ?>",
                            // url: $(this).data('url'),
                            type: 'get',
