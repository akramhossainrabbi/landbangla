...
?>
<?php echo Html::script('nptl-admin/js/plugin/jquery-validate/jquery.validate.min.js'); ?>

<?php echo Html::script('https://unpkg.com/sweetalert/dist/sweetalert.min.js'); ?>

<?php echo Html::script('additional/toastr/toastr.min.js'); ?>


<?php echo Html::script('additional/js/swiper.jquery.min.js'); ?>

<?php echo Html::script('additional/js/main.js'); ?>

<?php echo Html::script('additional/js/nptl.js'); ?>
...
$(document).ready(function (){
    $('#location_filter').change(function (event) {
        ...
        $(".new_resoruce").empty();
        $.ajax({
            url: "<?php echo e(route('flatforsaleprojectsListNew1')); ?>",
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
        });
       $.ajax({
...
$(document).ready(function (){
    $('#location_1_filter').change(function (event) {
      
       var upzilaID = $(this).val();
       var districtID = $('#location_filter').val();
       var type = $('#type').val();
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type, upzilaID: upzilaID},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
...
$(document).ready(function (){
    $('#size').change(function (event) {
        ...
        var size = $(this).val();
       var upzilaID = $('#location_1_filter').val();
       var districtID = $('#location_filter').val();
       var type = $('#type').val();
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type, upzilaID: upzilaID, size:size},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
   ...
   $('#number_of_bed_room').change(function (event) {
       
  
        var number_of_bed_room = $(this).val();
        var size = $('#size').val();
       var upzilaID = $('#location_1_filter').val();
       var districtID = $('#location_filter').val();
       var type = $('#type').val();
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type, upzilaID: upzilaID, size:size, number_of_bed_room: number_of_bed_room},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
   ...
   $('#number_of_toilet').change(function (event) {
        var number_of_toilet = $(this).val();
        var number_of_bed_room = $('#number_of_bed_room').val();
        var size = $('#size').val();
       var upzilaID = $('#location_1_filter').val();
       var districtID = $('#location_filter').val();
       var type = $('#type').val();
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type, upzilaID: upzilaID, size:size, number_of_bed_room: number_of_bed_room, number_of_toilet:number_of_toilet},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
   ...
   $('#number_of_floor').change(function (event) {
        var number_of_floor = $(this).val();
        var number_of_toilet = $('#number_of_toilet').val();
        var number_of_bed_room = $('#number_of_bed_room').val();
        var size = $('#size').val();
       var upzilaID = $('#location_1_filter').val();
       var districtID = $('#location_filter').val();
       var type = $('#type').val();
        ...
        $.ajax({
            ...
            type: 'get',
            dataType: "json",
            data: {id: districtID, type: type, upzilaID: upzilaID, size:size, number_of_bed_room: number_of_bed_room, number_of_toilet:number_of_toilet, number_of_floor:number_of_floor},
            success: function (data) {
                console.log(data.project_data);
                $('.new_resoruce').append(data.project_data);
            }, 
   ...
   $('#land_area').change(function (event) {
        var land_area = $(this).val();
...
$(document).ready(function (){
        ...
        console.log(`ditrictid:${this.value}`);
        var districtID = this.value;
        $(".location_1 option").remove();
        $.ajax({
                url: "/get_locations/"+districtID,
                type: 'get',
                dataType: "json",
                // data: {id: districtID},
                success: function (data) {
...
$(document).ready(function (){
        $('.location_3').change(function (event) {
        console.log(`ditrictid:${this.value}`);
        var districtID = this.value;
        $(".location_4 option").remove();
        $.ajax({
                url: "/get_locations/"+districtID,
                type: 'get',
                dataType: "json",
                // data: {id: districtID},
                success: function (data) {
                    $('.location_4').append($('<option>', {value:'', text:'Please Select'}));
                    $.each( data, function(k, v) {
                    $('.location_4').append($('<option>', {value:v.id, text:v.name}));
                    });
                }, 
        });
    });
...
$(document).ready(function (){
        $('.location_2').change(function (event) {
        console.log(`locationid:${this.value}`);
        var districtID = $(this).val();

        $(".location_3 option").remove();
            $.ajax({
                    url: "<?php echo e(route('all_upazila')); ?>",
                    type: 'get',
                    dataType: "json",
                    ...
                    success: function (data) {
                        console.log(data);
                        $('.location_3').append($('<option>', {value:'', text:'Please Select'}));
                        $.each( data, function(k, v) {
                        $('.location_3').append($('<option>', {value:v.id, text:v.name}));
                        });
                    }, 
            });
    });
...
//        });
    ...
    if ($("#myInput").length > 0) {
        $("#myInput").on("keyup", function () {
            url = '<?php echo e(URL::route('main_search')); ?>';
            search_on_nptl_search(url);
        });
