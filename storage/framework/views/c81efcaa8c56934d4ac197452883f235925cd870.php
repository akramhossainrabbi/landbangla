...
<?php $__env->startSection("title", "Add Flat for sale"); ?>
<?php $__env->startSection("content"); ?>
    ...
    <section id="widget-grid" class="">
        <!-- row -->
        <div class="row">
            <?php echo Form::open(["method"=>"post","action"=>"Admin\Common\Flatforsales@store"]); ?>

            <?php echo $__env->make(("nptl-admin.common.flatforsale.form"),
