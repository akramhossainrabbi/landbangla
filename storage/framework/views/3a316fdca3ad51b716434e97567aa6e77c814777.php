<?php $__env->startSection("title","Edit Flat for sale"); ?>
<?php $__env->startSection("content"); ?>
    ...
    <section id="widget-grid" class="">
        <!-- row -->
        <div class="row">
            <?php echo Form::model($edit,["method"=>"PATCH","action"=>["Admin\Common\Flatforsales@update",$edit->id]]); ?>

            <?php echo $__env->make(("nptl-admin.common.flatforsale.form1"),
