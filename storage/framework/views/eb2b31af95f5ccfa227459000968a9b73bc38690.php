...
<?php $__env->startSection('title','Project Lists'); ?>
<?php $__env->startSection('content'); ?>
    <section id="widget-grid" class="">
    <?php
    $edit_projects = SM::check_this_method_access('projects', 'edit') ? 1 : 0;
    $projects_status_update = SM::check_this_method_access('projects', 'projects_status_update') ? 1 : 0;
    $delete_projects= SM::check_this_method_access('projects', 'delete') ? 1 : 0;
    $per = $edit_projects + $delete_projects;
    ?>
    <!-- row -->
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget" id="project_list_wid">
                    <header>
                                ...
                                <table id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>Categories</th>
                                         <th>Image</th>
                                         <th>Fav Icon</th>
                                        <?php if ($projects_status_update != 0): ?>
...
<?php $__env->startSection('footer_script'); ?>
    <script type="text/javascript">
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo e(route('dataProcessingflatforsale')); ?>",
                "dataType": "json",
                "type": "GET",
