...
//            $('#' + img_holder + ' .media_img').attr('src', src);
    ...
    if ($('#first_ph, #gallery_first_ph, #order_mail, #floor_gallery_first_ph').length > 0) {
        $('#first_ph, #gallery_first_ph, #order_mail, #floor_gallery_first_ph').on('click', '.remove_img', function () {
