    ...
    function product_search_data(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (count($product_data) > 0) {
                ...
                $output = '<div class="alert alert-info"><i class="fa fa-info"></i> No Products Found!</div>';
            }
            $files = array(
...
//            echo $output;
    ...
    private function getProductSearchData($searchtext)
    {
        ...
        if (count($product_data) > 0) {
            $output .= '<div class="container-fluid">
                          <div class="countData"> Products found: ' . count($product_data) . ' to search for "' . $text . '" </div>
            ...
            $output = '<div class="container-fluid">
                          <div class="countData">  
                          <div class="alert alert-info"><i class="fa fa-info"></i> No Products Found!
                        </div>
                         </div>
    ...
    /**
     * Products detail page show by slug
     *
     * @param $slug string
     *
...
//                exit;
                if (!empty($image)) {
                    ...
                    $data['attribute_image'] = '<img id="product-zoom" src="' . url('/storage/uploads/' . $final_imagename . '_472x575.' . $final_extension) . '" data-zoom-image="' . url('/storage/uploads/' . $final_imagename . '_1000x1500.' . $final_extension) . '" class="image-style" alt="Products-11">';
                } else {
                    $final_imagename = '';
                    $final_extension = '';
